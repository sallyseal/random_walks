...
for i = 1:length(walks)
    ...
    sigma = 0.5 # Can control the tightness/spread of the distribution by altering
...
for i in 1:1000000
    ...
    difference_si = hellinger(SI_av, SI_prime_av)
    difference_s = hellinger(S_av, S_prime_av)
